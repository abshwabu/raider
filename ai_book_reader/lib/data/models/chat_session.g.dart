...
extension ChatSessionQueryFilter
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> bookIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> bookIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterFilterCondition> bookIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ChatSessionQuerySortBy
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> sortByBookId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.asc);
    });
  }

  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> sortByBookIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatSessionQuerySortThenBy
  ...
  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> thenByBookId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.asc);
    });
  }

  QueryBuilder<ChatSession, ChatSession, QAfterSortBy> thenByBookIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.desc);
    });
  }
...
extension ChatSessionQueryWhereDistinct
  ...
  QueryBuilder<ChatSession, ChatSession, QDistinct> distinctByBookId() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatSessionQueryProperty
  ...
  QueryBuilder<ChatSession, int, QQueryOperations> bookIdProperty() {
    return QueryBuilder.apply(this, (query) {
